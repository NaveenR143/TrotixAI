    ...
    const sections = [
        {
            ...
            content: "Welcome to the job portal operated by Thanish AI Innovations (OPC) Pvt. Ltd. (\"we,\" \"our,\" or \"us\"). We are committed to protecting your personal information and your right to privacy.\n\nThis Privacy Policy explains how we collect, use, process, and protect your Personal Data when you use our website, mobile application, and related services (collectively, the \"Platform\"). This policy is designed to strictly comply with India's Digital Personal Data Protection Act, 2023 (DPDPA) and the Information Technology (Intermediary Guidelines and Digital Media Ethics Code) Rules, 2021.\n\nUnder the DPDPA 2023, Thanish AI Innovations (OPC) Pvt. Ltd. acts as the Data Fiduciary determining the purpose and means of processing your data, and you (the job seeker or employer) are the Data Principal."
        },
        {
