        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "1. Detect projects across all sections (not only 'projects' heading).\n"
                    "2. A project is typically a short named item followed by description or details.\n"
                    "3. Group descriptions, bullet points, and links under the nearest project.\n"
                    "4. Do NOT treat descriptive lines or learning points as separate projects.\n"
                    "5. Assign URLs to the closest relevant project.\n"
                    "6. Merge URLs if split across multiple lines.\n\n"
