...
class TOONFormatter:
    ...
    def build_schema_instructions() -> str:
        return (
            ...
            "- AGGRESSIVELY scan the entire resume for any mentions of awards, certifications, licenses, publications, patents, honors, or test scores (e.g., 'Employee of the Month', 'AWS Certified', 'Published in IEEE').\n"
            "- These may be found under headers like 'Awards', 'Certifications', 'Activities', 'Extracurriculars', or scattered within the summary or education sections.\n"
            "- Extract ALL of these into the single root 'accomplishments' string array.\n"
            "- Format each entry as a plain, consolidated string description combining the title, issuer, and date if available (e.g., 'AWS Certified Solutions Architect - Amazon Web Services (2023)').\n"
            "- Do NOT create separate objects or nested fields; combine all relevant details into the single string.\n\n"
