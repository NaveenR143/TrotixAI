    ...
    >
      ...
      <Tooltip title={userPoints < 20 ? `Need ${20 - userPoints} more credits` : "Click to get learning recommendations"}>
        <Button
          ...
          sx={{
            color: userPoints >= 20 ? "#059669" : "#94a3b8",
            borderColor: userPoints >= 20 ? "#d1fae5" : "#e2e8f0",
            "&:hover": {
              borderColor: userPoints >= 20 ? "#059669" : "#e2e8f0",
              bgcolor: userPoints >= 20 ? "#f0fdf4" : "transparent",
            },
          }}
        >
