...
export const GasPlantDispositionChart = ({ rawData }) => {
  const [options, setOptions] = useState({});

  const products = {
    "Plant Fuel": "PlantFuelMCF",
    "Gas Vented": "GasVentedMCF",
    "Gas Inlet": "GasInletMCF",
    "Gas Outlet": "GasOutletMCF",
    "Lease Fuel": "LeaseFuelMCF",
    ReInjected: "ReInjectedMCF",
    Shrinkage: "ShrinkageMCF",
    MeterDifference: "MeterDifferenceMCF",
    "Gas Flared": "GasFlaredMCF",
    "Total Disposition": "TotalDispositionMCF",
    "Gas Sold BTU": "GasSoldBTU",
  };
  ...
  useEffect(() => {
    if (rawData.length > 0) {
      setSelectedProduct("PlantFuelMCF");
    }
  }, [rawData]);
