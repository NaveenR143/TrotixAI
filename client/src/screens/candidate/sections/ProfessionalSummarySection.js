...
const ProfessionalSummarySection = ({ userId, profile, initialAbout, onSuccess, enhancedData }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const result = await profileAPI.updateUserSummary(userId, dataToUpdate);
