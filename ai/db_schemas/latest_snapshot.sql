...
CREATE FUNCTION public.grant_signup_credits() RETURNS trigger
    ...
    AS $$
DECLARE
    wallet_id INTEGER;  -- âœ… changed from UUID â†’ INTEGER
BEGIN
...
ALTER TABLE ONLY public.job_postings
    ADD CONSTRAINT job_postings_recruiter_id_fkey FOREIGN KEY (recruiter_id) REFERENCES public.recruiters(id);
